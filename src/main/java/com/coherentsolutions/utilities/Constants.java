...
public interface Constants {
    ...
    interface TestErrorMessage {
        ...
        String SCREENSHOT_CREATED = "Screenshot is created and saved to screenshots folder.";
        String SCREENSHOT_FAILURE = "Error during copying screenshot to destination folder.";
    }
}